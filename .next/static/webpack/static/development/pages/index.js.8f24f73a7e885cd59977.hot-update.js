...
function Home() {
  ...
  var _useInfiniteQuery = Object(react_query__WEBPACK_IMPORTED_MODULE_4__["useInfiniteQuery"])('projects', function _callee(_ref) {
    ...
    getPreviousPageParam: function getPreviousPageParam(firstPage) {
      var _firstPage$meta$links;

      return (_firstPage$meta$links = firstPage.meta.links.previous) !== null && _firstPage$meta$links !== void 0 ? _firstPage$meta$links : false;
    },
    getNextPageParam: function getNextPageParam(lastPage) {
      var _lastPage$meta$links$;

      return (_lastPage$meta$links$ = lastPage.meta.links.next) !== null && _lastPage$meta$links$ !== void 0 ? _lastPage$meta$links$ : false;
    }
  }),
...
//# sourceMappingURL=index.js.8f24f73a7e885cd59977.hot-update.js.map